	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<form role="form" class="col-md-12 go-right" method="post"
				action="{{route('fil_rouge.update', ['id'=> $filRouge->id])}}">
				 {!! csrf_field() !!}
				 <input type="hidden" name="_method" value="put"/> 
				<h2>Ajout d'un fil rouge</h2>
				<div class="form-group">
					<label for="nom">Nom du fil rouge</label> <input
						name="nom" type="text" class="form-control" required id="nom" value="{{$filRouge->nom}}">

				</div>
				<div class="form-group">
					<label for="nom">Num&eacute;ro du fil rouge</label> <input
						name="numero" type="text" class="form-control" required id="numero" value="{{$filRouge->numero}}">
